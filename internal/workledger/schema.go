...
func Migrate(ctx context.Context, db *sql.DB) error {
	...
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS verifier_results (work_item_id TEXT PRIMARY KEY REFERENCES work_items(id), verifier_id TEXT NOT NULL, completion_contract TEXT NOT NULL, contract_digest TEXT NOT NULL, task_evidence_digest TEXT NOT NULL, head_revision TEXT NOT NULL, outcome TEXT NOT NULL CHECK(outcome IN ('satisfied','missing_or_stale','continuation','escalated')), reason_codes_json TEXT NOT NULL, evidence_refs_json TEXT NOT NULL, recorded_at INTEGER NOT NULL)`,
